...
if st.session_state.show_analysis:
    ...
    if st.session_state.pred_val == 1:
        ...
        <div class="analysis-card">
            ...
            <p>Model memprediksi tingkat kepuasan sebesar <b>{st.session_state.p_happy:.1%}</b>. 
            Customer ini cenderung puas karena mendapatkan <b>kualitas layanan pengiriman yang baik</b>, 
            yang tercermin dari biaya delivery yang relatif lebih tinggi (indikasi layanan cepat/prioritas).</p>
            <hr>
            <b>Rekomendasi Tindakan:</b>
            <ul>
                <li><b>Maintain Service Quality:</b> Pertahankan standar layanan pengiriman (kecepatan & reliability).</li>
                <li><b>Premium Segmentation:</b> Targetkan customer ini untuk layanan prioritas atau express delivery.</li>
                <li><b>Loyalty Program:</b> Berikan reward untuk menjaga retensi customer dengan preferensi layanan tinggi.</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="analysis-card" style="border-left: 8px solid #ff4b4b;">
            ...
            <p>Terdapat risiko ketidakpuasan sebesar <b>{st.session_state.p_not_happy:.1%}</b>. 
            Hal ini mengindikasikan bahwa <b>kualitas layanan pengiriman belum optimal</b>, 
            yang seringkali tercermin dari biaya delivery yang lebih rendah (indikasi layanan standar/lambat).</p>
            <hr>
            <b>Rekomendasi Tindakan:</b>
            <ul>
                <li><b>Improve Delivery Service:</b> Tingkatkan kecepatan dan reliability pengiriman.</li>
                <li><b>Service Upgrade Option:</b> Tawarkan opsi delivery yang lebih cepat (express).</li>
                <li><b>Operational Evaluation:</b> Evaluasi performa logistik di area dengan biaya rendah.</li>
                <li><b>Customer Feedback Loop:</b> Kumpulkan feedback untuk validasi akar masalah layanan.</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
